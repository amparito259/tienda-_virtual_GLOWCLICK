# Tienda Virtual GLOWCLICK

GLOWCLICK es una tienda online especializada en la venta de productos de maquillaje y belleza, desarrollado con arquitectura **MVC (Modelo-Vista-Controlador)** en PHP nativo, MySQL y Vanilla JavaScript.
